...
//     Frustum result = {};
//     // Left plane
//     result.planes[0] = getPlane(points[6], points[4], points[2]);
//     // Right plane
//     result.planes[1] = getPlane(points[3], points[1], points[7]);
//     // Bottom plane
//     result.planes[2] = getPlane(points[3], points[7], points[2]);
//     // Top plane
//     result.planes[3] = getPlane(points[0], points[4], points[1]);
//     // Near plane
//     result.planes[4] = getPlane(points[2], points[0], points[3]);
//     // Far plane
//     result.planes[5] = getPlane(points[7], points[5], points[6]);
// 
//     return result;
// }
