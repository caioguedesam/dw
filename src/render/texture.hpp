...
enum ImageFormat
{
    ...
    FORMAT_RG16_UNORM           = VK_FORMAT_R16G16_UNORM,
    FORMAT_BGRA8_SRGB           = VK_FORMAT_B8G8R8A8_SRGB,
    FORMAT_RG32_SFLOAT          = VK_FORMAT_R32G32_SFLOAT,
    FORMAT_RGB32_SFLOAT         = VK_FORMAT_R32G32B32_SFLOAT,
    FORMAT_RGBA32_SFLOAT        = VK_FORMAT_R32G32B32A32_SFLOAT,
    FORMAT_RGBA16_SFLOAT        = VK_FORMAT_R16G16B16A16_SFLOAT,
    FORMAT_B10G11R11_UFLOAT     = VK_FORMAT_B10G11R11_UFLOAT_PACK32,
    FORMAT_A2RGB10_UNORM        = VK_FORMAT_A2R10G10B10_UNORM_PACK32,
    FORMAT_A2RGB10_SNORM        = VK_FORMAT_A2R10G10B10_SNORM_PACK32,
